...
<div class="site-about">
    ...
    <div class="q-item">
        <div class="question">
            <p>Решить задачу. Из пункта А в пункт В выехал автобус со скоростью 36 км/ч,
                в этот момент навстречу ему из пункта В выехал автомобиль со скоростью 48 км/ч,
                они встретились в пункте С.
                Какое расстояние между пунктами А и В, если расстояние между А и С 72км.?</p>
        </div>
        <div class="answer">

            <p>Время, которое затратил автобус - 72 / 36 = 2 часа.
                Аналогиное количество времени провел в пути и автомобиль - 2 часа.
                За этот период он проехал - 2 * 48 = 96 км. Значит, расстояние
                ВС = 96 км.
                Отсюда, АВ = АС + ВС = 72 + 96 = 168 км.
            </p>
